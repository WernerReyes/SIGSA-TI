                ...
                <div
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-2 mb-1">
                            <p class="font-mono text-xs text-muted-foreground bg-muted px-2 py-0.5 rounded-md">
                                TK-{{ ticket?.id.toString().padStart(3, '0') }}</p>
                ...
                <div class="grid lg:grid-cols-3 gap-4">
                    <div class="lg:col-span-2 grid md:grid-cols-2 gap-3">
                        <div class="flex items-start gap-3 p-4 rounded-lg border bg-card hover:bg-muted/50 transition">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm font-semibold mt-1">{{ ticket?.requester?.full_name ?? 'Sin dato' }}
                                </p>
                        ...
                        <div class="flex items-start gap-3 p-4 rounded-lg border bg-card hover:bg-muted/50 transition">
                            ...
                            <div class="flex-1">
                                <p class="text-xs font-medium text-muted-foreground uppercase tracking-wider">Asignado a
                                </p>
                        ...
                        <div class="flex items-start gap-3 p-4 rounded-lg border bg-card hover:bg-muted/50 transition">
                            ...
                            <div class="flex-1">
                                <p class="text-xs font-medium text-muted-foreground uppercase tracking-wider">Categoría
                                </p>
                                <Badge v-if="ticket?.category" :class="requestTypeOp(ticket?.category)?.bg"
                                    class="mt-1">
                        ...
                        <div class="flex items-start gap-3 p-4 rounded-lg border bg-card hover:bg-muted/50 transition">
                            ...
                            <div class="flex-1">
                                <p class="text-xs font-medium text-muted-foreground uppercase tracking-wider">Prioridad
                                </p>
                        ...
                        <div class="flex items-start gap-3 p-4 rounded-lg border bg-card hover:bg-muted/50 transition">
                            ...
                            <div class="flex-1">
                                <p class="text-xs font-medium text-muted-foreground uppercase tracking-wider">Impacto
                                </p>
                        ...
                        <div class="flex items-start gap-3 p-4 rounded-lg border bg-card hover:bg-muted/50 transition">
                            ...
                            <div class="flex-1">
                                <p class="text-xs font-medium text-muted-foreground uppercase tracking-wider">Urgencia
                                </p>
                                <Badge variant="outline" class="mt-1">
                                    {{ urgencyLabels[ticket?.urgency ?? ''] ?? 'Sin dato' }}</Badge>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="rounded-lg border bg-card overflow-hidden">
                            <div
                                class="flex items-center gap-2 text-xs font-semibold uppercase text-muted-foreground px-4 py-3 bg-muted/30">
                                <Clock class="size-4" />
                                SLA Respuesta
                            </div>
                            <div class="p-4 space-y-3">
                                <div v-if="ticket?.sla_response_time_minutes" class="space-y-2">
                                    <Badge v-if="ticket.sla_response_time_minutes.late_minutes"
                                        class="bg-red-500 text-white w-full justify-center py-2">
                                        <Clock class="size-4" />
                                        {{ formatMinutes(ticket.sla_response_time_minutes.late_minutes) }} tarde
                                    </Badge>
                                    <Badge v-else-if="ticket.sla_response_time_minutes.before_late_minutes"
                                    ...
                                    <Badge v-else-if="ticket.sla_response_time_minutes.remaining_minutes"
                                        class="bg-yellow-500 text-white w-full justify-center py-2">
                                        <Clock class="size-4" />
                                        {{ formatMinutes(ticket.sla_response_time_minutes.remaining_minutes) }}
                                        restantes
                                    </Badge>
                                </div>
                                <div class="grid gap-2 text-xs">
                                    ...
                                    <div class="flex items-center justify-between py-1">
                                        ...
                                        <span class="font-medium"
                                            :class="{ 'text-muted-foreground/60 italic': !ticket?.first_response_at }">
                        ...
                        <div class="rounded-lg border bg-card overflow-hidden">
                            ...
                            <div class="p-4 space-y-3">
                                <div v-if="ticket?.sla_resolution_time_minutes" class="space-y-2">
                                    <Badge v-if="ticket.sla_resolution_time_minutes.late_minutes"
                                        class="bg-red-500 text-white w-full justify-center py-2">
                                        <Clock class="size-4" />
                                        {{ formatMinutes(ticket.sla_resolution_time_minutes.late_minutes) }} tarde
                                    </Badge>
                                    <Badge v-else-if="ticket.sla_resolution_time_minutes.before_late_minutes"
                                        class="bg-green-500 text-white w-full justify-center py-2">
                                        <CheckCircle2 class="size-4" />
                                        {{ formatMinutes(ticket.sla_resolution_time_minutes.before_late_minutes) }}
                                        antes
                                    </Badge>
                                    <Badge v-else-if="ticket.sla_resolution_time_minutes.remaining_minutes"
                                        class="bg-yellow-500 text-white w-full justify-center py-2">
                                        <Clock class="size-4" />
                                        {{ formatMinutes(ticket.sla_resolution_time_minutes.remaining_minutes) }}
                                        restantes
                                    </Badge>
                                </div>
                                <div class="grid gap-2 text-xs">
                                    ...
                                    <div class="flex items-center justify-between py-1">
                                        ...
                                        <span class="font-medium"
                                            :class="{ 'text-muted-foreground/60 italic': !ticket?.resolved_at }">
