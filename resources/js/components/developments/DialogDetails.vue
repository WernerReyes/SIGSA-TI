                ...
                <div class="space-y-6 px-4 pb-5 sm:px-6 sm:pb-6">
                    ...
                    <section class="space-y-4 rounded-lg border border-border/80 bg-muted/20 p-3 sm:p-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <!-- Technical Approval -->
                            <div :class="`p-3 rounded-lg border-2 space-y-3 transition-all ${currentDevelopment?.technical_approval
                                ? currentDevelopment.technical_approval.status === 'APPROVED'
                            ...
                            <!-- Strategic Approval -->
                            <div :class="`p-3 rounded-lg border-2 space-y-3 transition-all ${currentDevelopment?.strategic_approval
                    ...
                    >
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center gap-2 rounded-md border border-border/50 bg-background/50 p-3">
                    ...
                    <!-- Attached Files -->
                    <section
                     v-if="currentDevelopment?.requirement_url"
                    class="space-y-3 rounded-lg border border-border/80 bg-muted/20 p-3 sm:p-4">
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-muted-foreground">
                                    {{ currentDevelopment?.requirement_url ? 'Documento cargado' : 'Sin archivo adjunto' }}
                                </p>
                            </div>
                        </div>
                        <div v-if="currentDevelopment?.requirement_url" class="flex flex-col gap-2 sm:flex-row sm:items-center">
                        ...
                        <div v-else class="rounded-md border border-dashed border-border/60 bg-background/40 px-3 py-2 text-xs text-muted-foreground">
