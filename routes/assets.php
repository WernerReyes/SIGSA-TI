...
Route::middleware('department:' . Allowed::SYSTEM_TI->value)->group(function () {
    ...
    Route::get('/', [AssetController::class, 'renderView'])->name('assets');
        Route::get('/users', [AssetController::class, 'renderUsers'])->name('assets.users');
        Route::get('/departments', [AssetController::class, 'renderDepartments'])->name('assets.departments');
